...
def gravitational_potential_energy(mass, height, gravitational_acceleration=9.80665):
    ...
    :param gravitational_acceleration: (float, optional) Acceleration due to gravity in meters per second-squared
    :return: (float)                            Gravitational potential energy (near surface of a a large body
    """
